          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                <form action='https://getform.io/f/e692af11-e5f2-49a9-8286-7743126b0ec5' method='POST' onSubmit={() => handleSubmit()}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" name="Phone Number" value={formDetails.phone} placeholder="Phone No." onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
